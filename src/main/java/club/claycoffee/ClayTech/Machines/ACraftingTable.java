...
public abstract class ACraftingTable extends SlimefunItem implements InventoryBlock, EnergyNetComponent{
	...
	private static final ItemStack BORDER_ITEM = Utils.newItemD(Material.LIGHT_BLUE_STAINED_GLASS_PANE,"§bSplit line");
	private static final ItemStack OTHERBORDER_ITEM = Utils.newItemD(Material.LIME_STAINED_GLASS_PANE,"§aSplit line");
	...
	public void SetupMenu(BlockMenuPreset Preset) {
		...
		Preset.addItem(4, Utils.addLore(Utils.newItem(Material.BLACK_STAINED_GLASS_PANE), " "), ChestMenuUtils.getEmptyClickHandler());
		Preset.addItem(5, BORDER_ITEM, ChestMenuUtils.getEmptyClickHandler());
