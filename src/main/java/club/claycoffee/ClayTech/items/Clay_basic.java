...
public class Clay_basic {
	public Clay_basic() {
		...
		Research basic = new Research(new NamespacedKey(ClayTech.plugin, "CLAYTECH_BASIC"), 9900, "The start of ClayTech", 20);
		basic.addItems(SlimefunItem.getByItem(Defines.MAGIC_CLAY), SlimefunItem.getByItem(Defines.CLAY_STICK));
		basic.register();
		
		Research basic2 = new Research(new NamespacedKey(ClayTech.plugin, "CLAYTECH_ELECBASIC"), 9915, "Electrical equipment I", 65);
