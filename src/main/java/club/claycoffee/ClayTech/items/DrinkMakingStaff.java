...
public class DrinkMakingStaff {
	public DrinkMakingStaff() {
		ItemStack[] recipea = {new ItemStack(Material.COCOA_BEANS),new ItemStack(Material.COCOA_BEANS),new ItemStack(Material.COCOA_BEANS),new ItemStack(Material.COCOA_BEANS),Defines.CLAY_STICK,new ItemStack(Material.COCOA_BEANS),new ItemStack(Material.COCOA_BEANS),new ItemStack(Material.COCOA_BEANS),new ItemStack(Material.COCOA_BEANS)};
		ItemStack[] recipeb = {null,null,null,null,SlimefunItems.BUCKET_OF_OIL,null,null,null,null};
		ItemStack[] recipec = {Defines.PLASTIC,Defines.PLASTIC,Defines.PLASTIC,Defines.PLASTIC,Defines.MAGIC_CLAY,Defines.PLASTIC,Defines.PLASTIC,Defines.PLASTIC,Defines.PLASTIC};
		...
		Slimefunutils.registerItem(Defines.C_FOODMATERIALS, "DIRTY_DRINK_BOTTLE", Defines.DIRTY_DRINK_BOTTLE, "notresearch", 10,
